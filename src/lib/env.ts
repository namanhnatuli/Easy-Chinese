...
const serverEnvSchema = publicEnvSchema.extend({
  ...
  TTS_PROVIDER: z.enum(["azure", "google"]).optional(),
  TTS_DEFAULT_LANGUAGE: z.string().min(2).optional(),
  TTS_DEFAULT_VOICE: z.string().min(1).optional(),
  ...
  TTS_ALLOWED_AZURE_VOICES: z.string().optional(),
  TTS_ALLOWED_GOOGLE_VOICES: z.string().optional(),
...
export function getServerEnv() {
  cachedServerEnv ??= serverEnvSchema.parse({
    ...
    TTS_PROVIDER: normalizeOptionalEnv(process.env.TTS_PROVIDER),
    TTS_DEFAULT_LANGUAGE: normalizeOptionalEnv(process.env.TTS_DEFAULT_LANGUAGE),
    TTS_DEFAULT_VOICE: normalizeOptionalEnv(process.env.TTS_DEFAULT_VOICE),
    ...
    TTS_ALLOWED_AZURE_VOICES: normalizeOptionalEnv(process.env.TTS_ALLOWED_AZURE_VOICES),
    TTS_ALLOWED_GOOGLE_VOICES: normalizeOptionalEnv(process.env.TTS_ALLOWED_GOOGLE_VOICES),
